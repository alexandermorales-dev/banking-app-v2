	...
	return (
		<div className="nav-bar">
			<nav className="navbar navbar-expand-lg bg-body-tertiary">
				...
				<form onSubmit={handleLogin} className="d-flex col-10 col-md-8 col-lg-4 justify-content-end order-1">
					...
					<button type="submit" className="btn btn-light border rounded-pill px-4 py-2 fw-semibold shadow-sm" style={{ fontSize: '14px' }}>Log in</button>
				</form>
			</nav>
		</div>
	);
